  ...
  <div class="toast align-items-center bg-danger-subtle border-0 mx-auto w-100" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="d-flex">
      <div class="toast-body text-danger">
       erruer : se compte est deja existe.
      </div>
    ...
    <div class="card mb-3 w-75 mx-auto border-0" style="margin-top: 10%;">
        <div class="row g-0 ">
          ...
          <div class="col-md-8 bg-light-subtle  shadow-lg rounded-3">
            <form class="card-body" action ="/creataccount/new" method="post">
            @csrf
              <h1 class="card-title text-center ">log in</h1>
              <div class="input-group mb-3 mt-5">
                <span class="input-group-text" id="basic-addon1">nom</span>
                <input type="text" class="form-control" placeholder="nom" aria-label="Username" aria-describedby="basic-addon1" name = "firstname" required>
              </div>
              <div class="input-group mb-3 mt-5">
                <span class="input-group-text" id="basic-addon1">prenom</span>
                <input type="text" class="form-control" placeholder="prenom" aria-label="Username" aria-describedby="basic-addon1" name = "lastname" required>
              </div>
              <div class="input-group mb-3 mt-5">
              ...
              <div class = "mt-5 d-flex justify-content-center gap-2">
                <input type="submit" class ="btn btn-primary" name = "submit" value="creat">
                <h6>already have one? <a href="/creataccount">log in</a></h6>
              </div>
