...
<body>
    <div class=" bg-gradient-to-b p-16 from-gray-200 to-gray-300 dark:from-gray-950 dark:to-violet-950">
        <!-- <div> -->
            <!-- <img src="https://th.bing.com/th/id/OIP.2TumufLJYnKvtmU6UMWe6wHaE8?rs=1&pid=ImgDetMain" width="200px" height="60px" alt=""> -->
        <!-- </div> -->
        <div class="p-8 bg-white shadow mt-24 dark:bg-zinc-800">
            <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                <div class="space-x-8 flex justify-between mt-32 md:mt-0 md:justify-center"><button
                        id = "settings"class="text-white py-2 px-4 uppercase rounded bg-blue-400 hover:bg-blue-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">
                        Settings</button> <button id="dark-mode" onclick="darkmode()"
    ...
    <svg class="fill-current h-6 w-6 text-red-500 ltr" onclick="closeAlert()" role="button" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <div id ="settings_section" class="mn-6 transition-opacity duration-1000 ease-in-out opacity-0 duration-300 hidden p-6 absolute text-center bg-white dark:bg-zinc-800 w-1/2 h-48 text-center top-28 ml-auto mr-auto inset-0">
        <h2 class = "text-3xl mb-16">Settings</h2>

        <a href="/logout" class = "bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-6 rounded-full dark:bg-red-900 dark:hover:bg-red-700 text-center my-10">Log out</a>
...
function closeAlert() {
            var alert = document.getElementById('settings_section');
...
settings.addEventListener("click", function(){
    ...
    document.getElementById('settings_section').classList.toggle('opacity-100');
